...
$ n_{i}^{(\ell + 1)} = \mathcal{N}^{(\ell + 1)} \left( \left[ n_{i}^{(\ell)}, \bigoplus_{j \in \mathfrak{N}_i} e_{i j}^{(\ell + 1)} \right]  \right)$ ,
...
$\bigoplus_{j \in \mathfrak{N}_i} e_{i j}^{(\ell + 1)} = \left[ \max_{j \in \mathfrak{N}_i} e_{i j}^{(\ell + 1)},
   \sum_{j \in \mathfrak{N}_i} e_{i j}^{(\ell + 1)}, \frac{ \sum_{j \in \mathfrak{N}_i} e_{i j}^{(\ell + 1)} }{ \sum_{j \in \mathfrak{N}_i} } \right]$.

...
$\mathbf{e}_{i j}^{(\ell + 1)} = \mathcal{E}^{(\ell + 1)} \left( \left[ \mathbf{n}_{i}^{(\ell)}, \mathbf{n}_{j}^{(\ell)}, \mathbf{e}_{i j}^{(\ell)} \right]  \right)$,

where $\mathcal{E}^{(\ell + 1)}$ represents a MLP;

* **Node model:**

$ \mathbf{n}_{i}^{(\ell + 1)} = \mathcal{N}^{(\ell + 1)} \left( \left[ \mathbf{n}_{i}^{(\ell)}, \bigoplus_{j \in \mathfrak{N}_i} \mathbf{e}_{i j}^{(\ell + 1)} \right]  \right)$ ,
...
$\bigoplus_{j \in \mathfrak{N}_i} \mathbf{e}_{i j}^{(\ell + 1)} = \left[ \max_{j \in \mathfrak{N}_i} \mathbf{e}_{i j}^{(\ell + 1)},
   \sum_{j \in \mathfrak{N}_i} \mathbf{e}_{i j}^{(\ell + 1)}, \frac{ \sum_{j \in \mathfrak{N}_i} \mathbf{e}_{i j}^{(\ell + 1)} }{ \sum_{j \in \mathfrak{N}_i} } \right]$.

...
`dataset = create_graphs_kNN(pos, NB)`
...
training, validation and testing subsets. We can do so using the following function:
...
Remember, you can find the complete code in: `Google Colab`: [![Open this notebook in Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/natalidesanti/pytorch_and_GNNs/blob/main/GNNs.ipynb)

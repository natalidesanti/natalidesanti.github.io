...
where
\begin{align}
 \widetilde{H} & = \frac{2}{\hbar \omega} H = \xi^2 - \frac{d^2}{d\xi^2} \\
 & = \frac{A A^{\dagger} + A^{\dagger} A}{2} = A^{\dagger} A + 1 ,\\
 A & = \xi + \frac{d}{d\xi} ,\\
...
\begin{equation}
 y(x_0) = y_0 , \hspace{1cm} y'(x_0) = y'_0.
\end{equation}  
...
is given as follows
\begin{align}
 y_{i-1} & = y_i - y'_i\Delta x + \frac{1}{2}y''_i {\Delta x}^2 - \frac{1}{6}y'''_i {\Delta x}^3
                  + \frac{1}{24}y''''_i {\Delta x}^4 - \frac{1}{120}y''''_i {\Delta x}^5 + O[{\Delta x}^6]\\
 y_{i+1} & = y_i + y'_i\Delta x + \frac{1}{2}y''_i {\Delta x}^2 + \frac{1}{6}y'''_i {\Delta x}^3
                  + \frac{1}{24}y''''_i {\Delta x}^4 + \frac{1}{120}y''''_i {\Delta x}^5 + O[{\Delta x}^6],
\end{align}

...
At higher temperatures (room temperature, for instance) an electric field is able to move the electrons in some oriented direction and that is the _electric current_. However, the thermal effects leads to the excitation of the positive particles, that interferes with the movement without interruption of electrons - this is the _electric resistance_.
